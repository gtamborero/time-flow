    ...
    export default {
      ...
      methods: {
        ...
        getSiblingUser: function (){
          if (this.actualUserId == this.buyerUser.id) return capitalize(this.sellerUser.name);
          if (this.actualUserId == this.sellerUser.id) return capitalize(this.buyerUser.name);
        },
        ...
        infoForUser: function (){
          ...
          if (this.status == 0){
              ...
              var infoNotInvolved = `${capitalize(this.buyerUser.name)}
              ...
              var info = `${capitalize(this.siblingUser)}
              ...
              var infoBuyerAndCreator = `${capitalize(this.buyerUser.name)}
                ${this.$t('want\'s to pay')}
                ${this.amount}
                ${this.$t('to')}
                ${capitalize(this.siblingUser)}
                ${this.$t('for')}:
                <div class="hidden md:block"></div>
