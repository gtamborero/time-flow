...
@section('content')
  ...
  @endif
    ...
    <div class=" p-4 my-5 break-words text-2xl text-primary text-center font-medium bg-white">
      ...
      <div class="text-base text-gray w-full lg:w-1/2 mx-auto mt-3">
      ...
      <div id="locationField" class="text-base text-gray ">
          ...
          <br>
          <input class="form-input w-full lg:w-1/2 mt-3 mb-4 text-black"
          type="text" name="town" value="{{Auth::user()->town}} - {{Auth::user()->postalcode}}">
